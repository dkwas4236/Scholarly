...
@Composable
fun BottomTutorBar(navController: NavController, bottomBarState: MutableState<Boolean>) {
        ...
        NavigationBar(
            ...
            items.forEachIndexed { index, item ->
                NavigationBarItem(
                    ...
                    onClick = {
                        when (index) {
                            0 -> navController.navigate("tutor")
                            1 -> navController.navigate("settingstutor")
                        }
                    }
                )
            }
